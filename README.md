...
credentials authorized for the operation. Defaults are `http://localhost:8000`,
Digest auth and `admin` / `admin`.
...
See the [Python guide](https://monasticus.github.io/mlclient/latest/user/clients/)
