...
class DocumentsDisposition(BaseModel):
    """A class representing /v1/documents body part Content-Disposition header."""

    model_config = {"populate_by_name": True}

    type_: DocumentsBodyPartType = Field(
    ...
    def is_attachment(self) -> bool:
        ...
        return self.type_ == DocumentsBodyPartType.ATTACHMENT

    @property
    def is_inline(self) -> bool:
        """Whether this disposition is inline (default metadata part)."""
        return self.type_ == DocumentsBodyPartType.INLINE

    @classmethod
    def from_header(cls, header: str) -> DocumentsDisposition:
        ...
        -------
        DocumentsDisposition
            A parsed DocumentsDisposition instance
        """
...
class DocumentsBodyPart(BaseModel):
    ...
    disposition: DocumentsDisposition = Field(
    ...
    def parse_disposition(
        ...
        if isinstance(value, dict):
            return DocumentsDisposition(**value)
        return DocumentsDisposition.from_header(value)


class _DispositionMapping:
    """Internal mapping between DocumentsDisposition fields and HTTP header params."""
