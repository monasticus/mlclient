...
def test_endpoint():
    assert ServerGetCall(server="1", group_id="Default").endpoint() == "/manage/v2/servers/1"
    assert ServerGetCall(server="App-Services", group_id="Default").endpoint() == "/manage/v2/servers/App-Services"
