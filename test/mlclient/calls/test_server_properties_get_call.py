...
def test_validation_format_param():
    with pytest.raises(exceptions.WrongParameters) as err:
        ServerPropertiesGetCall(server="App-Services", group_id="Default", data_format="text")
...
def test_endpoint():
    ...
    assert ServerPropertiesGetCall(server="1", group_id="Default").endpoint() == expected__id_endpoint
    assert ServerPropertiesGetCall(server="App-Services", group_id="Default").endpoint() == expected__name_endpoint
...
def test_headers_for_none_format():
    call = ServerPropertiesGetCall(server="App-Services", group_id="Default", data_format=None)
    assert call.headers() == {
        "accept": "application/xml"
    }
...
def test_headers_for_html_format():
    call = ServerPropertiesGetCall(server="App-Services", group_id="Default", data_format="html")
    assert call.headers() == {
        "accept": "text/html"
    }
...
def test_headers_for_xml_format():
    call = ServerPropertiesGetCall(server="App-Services", group_id="Default", data_format="xml")
    assert call.headers() == {
        "accept": "application/xml"
    }
...
def test_headers_for_json_format():
    call = ServerPropertiesGetCall(server="App-Services", group_id="Default", data_format="json")
    assert call.headers() == {
...
def test_fully_parametrized_call():
    call = ServerPropertiesGetCall(server="App-Services",
                                   group_id="Default",
                                   data_format="json")
