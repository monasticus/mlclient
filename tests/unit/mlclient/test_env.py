...
def test_server_ssl_overrides_root_verify():
    config = MLEnvironment(
        **{
            "app-name": "app",
            "protocol": "https",
...
def test_server_ssl_can_disable_root_verify():
    config = MLEnvironment(
        **{
            "app-name": "app",
            "protocol": "https",
            "ssl": {"verify": "/certs/root-ca.pem"},
            "app-servers": [
                {"id": "secure", "port": 8010, "ssl": {"verify": False}},
            ],
        },
    )
